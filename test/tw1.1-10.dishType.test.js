...
describe("TW1.1 dishType", function() {
    ...
    it("knownTypeCB recognizes only starter, main course, dessert", function(){
        return assert.equal(isKnownTypeCB("starter"), true)
    ...
    it("dishType returns a known dish type", function(){ return assert.equal(dishType(dishesConst[4]), "main course");});
    ...
    it("dishType returns empty string if starter, main course, dessert not present", function(){ return assert.equal(dishType(dishesConst[0]), "");});
    it("dishType returns empty string if dishTypes property not present", function(){ return assert.equal(dishType(dishesConst[7]), "");});
});
